if not getgenv().library then
    getgenv().library = loadstring(game:HttpGet("https://pastebin.com/raw/wAVrjPwk"))()
end
...
local A = {
    ...
    [3] = {
        ...
        [6] = {
            ...
            [10] = {
                ...
                "Sound",
                p,
                {options = {"Skeet", "Minecraft", "Terraria", "Slap", "Custom"}},
                "Hitsound_Sound"
            },
    ...
    [4] = {
        ...
        [1] = {
            name = "Bunny Hop",
            [1] = {"Checkbox", "Enabled", p, {}, "Enabled"},
            [2] = {"Slider", "Speed", p, {min = 15, max = 200, precise = true, default = 33}, "Speed"}
        },
        [2] = {
            name = "Anti-Damage",
    ...
    [5] = {
        ...
        [1] = {
            ...
            [2] = {"Button", "Save Config", function()
                    game:GetService("AllahWare").ConfigEvent:Fire(
                        "SaveConfig",
